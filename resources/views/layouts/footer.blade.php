<div class="container">
    <footer class="py-5">
        <div class="row">
            <div class="col-6 col-md-2 mb-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Update</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Delete</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-5 offset-md-1 mb-3">
                <form>
                    <h5>Berlangganan berita tentang kami</h5>
                    <p>Intisari bulanan tentang apa yang baru dan menarik dari kami.</p>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between py-4 border-top">
            <p>&copy; 2023 Neucertify, Inc. All rights reserved.</p>
